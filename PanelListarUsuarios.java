...
public class PanelListarUsuarios extends javax.swing.JPanel {
    ...
    private void btEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditarActionPerformed
        try {
            ...
            String sql = "SELECT Cedula, Nombre FROM [dbo].[Usuarios];";
            ...
            nombresArr = nombres.toArray(nombresArr);
            ...
            int indexSelected = nombres.indexOf(strOpcion);
            String cedula_buscada = cedulas.get(indexSelected);
            
            System.out.println(cedula_buscada);

            Principal_Admin objFrame = (Principal_Admin) SwingUtilities.getAncestorOfClass(Principal_Admin.class, this);
            objFrame.changeToEditUsers(cedula_buscada);
...
@Override
    public void setVisible ( boolean value ) {
        ...
        if ( value ) { 
            ...
            txtCedula.setText("");
            rbPerfilOperario.setSelected(false);
            rbPerfilAdministrador.setSelected(false);
        }
